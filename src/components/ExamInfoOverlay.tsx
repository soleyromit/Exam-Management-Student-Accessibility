...
export function ExamInfoOverlay({ onClose }: ExamInfoOverlayProps) {
  return (
        ...
        <div
          ...
          <div>
            ...
            <div
              ...
              <ul
                ...
                <li
                  className="flex items-start font-heading"
                  style={{
                    gap: '8px',
                    fontSize: '14px',
                    color: tokens.text.secondary
          ...
          <div>
            ...
            <div
              ...
              {STAT_CARDS.map(
                ({ label, value, icon: Icon, iconColor, badgeBg }) =>
          ...
          <div>
            <h3
              className="font-heading font-bold flex items-center"
              style={{
                fontSize: '12px',
                color: tokens.text.primary,
                textTransform: 'uppercase',
