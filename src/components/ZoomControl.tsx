  ...
  return (
    <div className="relative">
      ...
      <button
        ...
        className="flex items-center justify-center rounded-lg transition-colors hover:bg-slate-100 focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 relative group"
        style={{
          width: '44px',
          height: '44px',
        ...
        {zoomPercent > 100 &&
        <span
          className="absolute -bottom-1 -right-1 font-heading font-bold rounded-full flex items-center justify-center"
          style={{
      ...
      <div
        ref={panelRef}
        className="absolute top-full mt-2 right-0 z-50 overflow-hidden"
        role="dialog"
        ...
        style={{
          ...
          style={{
            ...
            style={{
              ...
              className="flex items-center justify-center rounded-lg transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2"
              style={{
                width: '32px',
                height: '32px',
                flexShrink: 0,
              ...
              <div className="relative flex-1 flex items-center h-8">
                {/* Custom Slider Track */}
                <div
                className="absolute w-full h-1 rounded-full pointer-events-none"
                style={{
                ...
                <div
                className="absolute w-5 h-5 rounded-full shadow-sm pointer-events-none transition-transform"
                style={{
                  backgroundColor: tokens.brand.primary,
            ...
            {/* Live Preview */}
            <div
            className="mt-8 mb-4 p-3 rounded-lg flex items-center justify-center overflow-hidden"
            style={{
              backgroundColor: tokens.surface.subtle,
              border: `1px solid ${tokens.border.default}`,
              minHeight: '60px'
            ...
            aria-hidden="true">
              ...
              <span
              className="font-heading text-center whitespace-nowrap"
              style={{
            ...
            <div className="text-center">
              ...
              onClick={resetZoom}
              disabled={zoomPercent === 100}
              className="font-heading text-sm hover:underline focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 rounded px-2 py-1"
              style={{
                color:
                zoomPercent === 100 ?
                tokens.text.placeholder :
