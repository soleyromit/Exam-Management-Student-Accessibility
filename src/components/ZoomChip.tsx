...
export function ZoomChip({ zoomPercent, onClick }: ZoomChipProps) {
  ...
  return (
    <button
      onClick={onClick}
      className="inline-flex items-center rounded-full transition-colors hover:bg-slate-200 focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 mb-4"
      style={{
