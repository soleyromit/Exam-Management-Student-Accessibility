...
export function CollapsedNavigator({
  ...
  return (
    <div
      className="fixed bottom-0 left-0 right-0 z-40 flex items-center justify-between px-4 py-3 shadow-[0_-4px_12px_rgba(0,0,0,0.05)]"
      style={{
      ...
      <button
        onClick={onExpand}
        className="flex items-center gap-2 rounded-lg px-3 py-2 transition-colors hover:bg-slate-100 focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 shrink-0 ml-4"
        style={{
        ...
        <span
          className="font-heading font-semibold hidden sm:inline"
          style={{
            fontSize: '14px'
          }}>
