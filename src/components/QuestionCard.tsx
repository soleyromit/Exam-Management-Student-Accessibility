...
export function QuestionCard({
  ...
  const displayValue =
  question.type === 'short-answer' ? selectedAnswer || '' : '';
              ...
              style={{
                ...
                return (
                  ...
                  <button
                    ...
                    className="w-full flex items-center text-left transition-all focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2"
                    style={{
                      minHeight: '48px',
                      height: 'auto',
                      paddingTop: '12px',
                      ...
                      tokens.brand.primaryBg :
                      tokens.surface.white,
          ...
          <div
            style={{
              ...
              <div className="relative" ref={dropdownRef}>
                ...
                className="w-full flex items-center justify-between text-left transition-all focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2"
                style={{
                  minHeight: '48px',
                  height: 'auto',
                  paddingTop: '12px',
                ...
                style={{
                  ...
                  return (
                    ...
                    <button
                      ...
                      className="w-full text-left font-heading transition-colors"
                      style={{
                        fontSize: '1em',
                        lineHeight: 1.5,
                        padding: '14px 18px',
          ...
          <div
            style={{
              ...
              <div className="relative">
                ...
                className="w-full font-heading resize-none focus:outline-none transition-colors"
                style={{
                  fontSize: '1em',
                  lineHeight: 1.5,
                  height: '200px',
              ...
              <button
                ...
                className={`absolute top-3 right-3 flex items-center rounded-lg font-heading font-medium transition-all ${isSpeechListening ? 'bg-red-500 text-white shadow-md' : 'bg-slate-100 hover:bg-slate-200'}`}
                style={{
                  fontSize: '0.8125em',
                  gap: '6px',
                  padding: '6px 12px',
                ...
                aria-label={
                isSpeechListening ? 'Stop dictation' : 'Start dictation'
                }>
