...
export function ExamHeader({
  ...
  return (
    ...
    <header
      className="flex items-center justify-between z-30 relative"
      style={{
        height: '48px',
      ...
      <div
        ...
        <>
            ...
            <button
            className="flex items-center justify-center rounded-md transition-colors hover:bg-slate-100 focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2"
            style={{
              width: '44px',
              height: '32px',
            ...
            <button
            className="flex items-center justify-center rounded-md transition-colors overflow-hidden focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2"
            style={{
              width: '52px',
              height: '32px',
              outlineColor: tokens.brand.primary
            ...
            <button
            className="flex items-center justify-center rounded-md overflow-hidden focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2"
            style={{
              width: '120px',
              height: '32px',
              outlineColor: tokens.brand.primary
        ...
        <div className="relative" ref={moreRef}>
            ...
            className="flex items-center justify-center rounded-md transition-colors hover:bg-slate-100 focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 px-3"
            style={{
              height: '32px',
              outlineColor: tokens.brand.primary
            }}
            ...
            {showMore &&
          <div
            className="absolute top-full right-0 mt-2 py-2 rounded-lg shadow-lg z-50 flex flex-col"
            style={{
              backgroundColor: tokens.surface.white,
        ...
        <button
          className="flex items-center justify-center rounded-md transition-colors hover:bg-slate-50 focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2"
          style={{
            height: '40px',
            padding: '0 12px',
            gap: '4px',
