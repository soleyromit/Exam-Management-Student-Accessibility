    ...
    <div
      ...
      <div
          ...
          <div
            ...
            {Array.from(
              ...
              <div key={i} className="relative">
                  ...
                  className="font-heading font-semibold transition-all hover:opacity-80"
                  style={{
                    width: '40px',
                    height: '40px',
                    borderRadius: '8px',
        ...
        <div
          ...
          <Button
            label={isFlaggedCurrent ? 'Unflag Question' : 'Flag for Review'}
            variant="secondary"
            icon={
            <FlagIcon
              style={{
            ...
            className={`w-full ${isFlaggedCurrent ? '!border-amber-400 !text-amber-600 !bg-amber-50' : ''}`} />
